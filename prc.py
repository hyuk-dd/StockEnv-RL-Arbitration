...
def data_split(df, start, end):
    """
    split the dataset into training or testing using dates
...
def preprocess_data():
    ...
    # df = load_dataset("/home/hail/Desktop/stock/new/mko.csv")
    df = pd.read_csv("/home/hail/Desktop/stock/new/mko.csv")
    # get data after 2009
